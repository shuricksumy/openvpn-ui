...
func init() {
	...
	web.GlobalControllerRouter["github.com/d3vilh/openvpn-ui/controllers:SystemController"] =
		append(web.GlobalControllerRouter["github.com/d3vilh/openvpn-ui/controllers:SystemController"],
			web.ControllerComments{
				Method:           "Restart",
